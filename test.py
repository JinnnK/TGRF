...
def main():
	...
	parser.add_argument('--model_dir', type=str, default='trained_models/TGRF_new')
	...
	parser.add_argument('--test_model', type=str, default='02000.pt')
	# whether to save traject-ories of episodes
