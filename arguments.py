...
def get_args():
    ...
    # If you want to run  multiple env, change the output name below
    parser.add_argument(
        '--output_dir', type=str, default='trained_models/TGRF')
    ...
    parser.add_argument(
        '--load-path', default='trained_models/TGRF_4/checkpoints/200000.pt',
